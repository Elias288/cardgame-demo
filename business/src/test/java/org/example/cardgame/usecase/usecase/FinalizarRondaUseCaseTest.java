...
class FinalizarRondaUseCaseTest {
    ...
    private Flux<DomainEvent> historico() {
        ...
        var event3 = new JugadorAgregado(
                ...
                new Mazo(Set.of(
                        new Carta(CartaMaestraId.of("sss2"), 999, true, true),
                        new Carta(CartaMaestraId.of("bbb2"), 102, true, true),
                        new Carta(CartaMaestraId.of("ccc2"), 101, true, true),
                        new Carta(CartaMaestraId.of("ddd2"), 104, true, true),
                        new Carta(CartaMaestraId.of("fff2"), 150, true, true),
                        new Carta(CartaMaestraId.of("ggg2"), 160, true, true)
                )));
